...
namespace Hope_tracKeR_back.Migrations
{
    ...
    [Migration("20260611121531_InitMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hope_tracKeR_back.Models.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Hope_tracKeR_back.Models.ItemAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Hope_tracKeR_back.Models.Item", b =>
                {
                    b.HasOne("Hope_tracKeR_back.Models.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hope_tracKeR_back.Models.Brand", "Brand")
                        .WithMany()
            ...
            modelBuilder.Entity("Hope_tracKeR_back.Models.ItemAttribute", b =>
                {
                    b.HasOne("Hope_tracKeR_back.Models.Item", "Item")
                        .WithMany("Attributes")
